...
['borderRadius', 'MozBorderRadius', 'WebkitBorderRadius', 'OBorderRadius', 'KhtmlBorderRadius'].each(function(property){
		if(document.body.style[property] != null) supportBorderRadius = true;
});
...
Element.implement({
	...
	getStyle: function(property){
		...
		property = (property == 'float' ? floatName : property).camelCase();
		if (property.match(/[Bb]orderRadius/)) return supportBorderRadius ? getBorderRadius(this) : null;
